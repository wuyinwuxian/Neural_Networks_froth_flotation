# 高性能
# 0.974
# Finished Traning,cost 6810.6440 seconds
...
from CNNgoogle_model import GoogLeNet
...
def main():
    ...
    epochs = 50
    best_acc = 0.0
    save_path = './CNNgooglenet_froth_netparams.pth'
    ...
    plt.savefig("CNNgoooglenet_froth.jpg")
    fig2 = plt.figure()
    plt.subplot(111)
    plt.plot(plot_epo, plot_accu, color='r', linestyle='-')
    plt.savefig("CNNgoooglenet_froth2.jpg")
